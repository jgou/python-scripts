...
- Supports a `--regions` flag to limit which AWS regions are scanned (all services except S3, Route 53, CloudFront, and CloudWatch Dashboards, which are always listed account-wide/global), comma-separated. Default is all regions.
